        ...
        <main className="max-w-7xl mx-auto px-4 py-10" ref={resultsRef}>
          ...
          {!showTravelPlanning ? (
            ...
            <div>
              ...
              <div className="mb-10">
                <div className="bg-white/80 dark:bg-gray-900/80 rounded-2xl shadow-lg p-6 flex flex-col items-center justify-center text-center border-2 border-pink-100 dark:border-indigo-900">
