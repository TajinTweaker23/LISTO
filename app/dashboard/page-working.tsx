      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-6 shadow-lg border border-sage-200">
              ...
              <div className="space-y-3">
                <button className="w-full bg-brand-primary text-white rounded-lg px-4 py-3 font-medium hover:bg-brand-dark transition-colors">
                  Log Symptoms
                </button>
                <button className="w-full bg-sage-600 text-white rounded-lg px-4 py-3 font-medium hover:bg-sage-700 transition-colors">
                  Check Mood
                </button>
                <button className="w-full bg-accent-primary text-white rounded-lg px-4 py-3 font-medium hover:bg-accent-dark transition-colors">
                  Add Task
                </button>
              </div>
            </div>
        ...
        <div className="mt-8 text-center">
          <div className="flex flex-wrap justify-center gap-3">
            <a href="/" className="px-4 py-2 bg-sage-600 text-white rounded-lg hover:bg-sage-700 transition-colors">
              ← Back to Home
            </a>
            <a href="/test-styling" className="px-4 py-2 bg-brand-primary text-white rounded-lg hover:bg-brand-dark transition-colors">
              Color Palette
            </a>
            <a href="/button-demo" className="px-4 py-2 bg-accent-primary text-white rounded-lg hover:bg-accent-dark transition-colors">
              Button Demo
            </a>
          </div>
        </div>
